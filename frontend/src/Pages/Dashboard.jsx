...
//   return (
//     <div className="min-h-screen  bg-[#1A3263] ">
//       {/* NAVBAR */}
//       <nav className="bg-[#1A3263] border-b border-gray-800 sticky top-0 z-50">
